...
#define SERIALCMDDELAY 100  // wait max 100ms for serial command data to arrive
...
// RF
  ...
  COMMAND (DR), // DR - RF datarate                 (0: 76.8k , 1 : 1.2k)
// Serial
...
enum RFBEEMODE {
   ...
   TRANSCEIVE_MODE=3,
   SLEEP_MODE=4,   
   //CMD_MODE=5,//remove it, as it is actually serialMode. --by Icing
} rfBeeMode;
